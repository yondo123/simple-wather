...
type ErrorStatus = number | '400' | '401' | '429' | '404' | '500';
...
export const StatusCodes: Record<ErrorStatus, string> = {
  '400': ApplicationError.BAD_REQUEST,
  '401': ApplicationError.UNAUTHORIZED,
  '429': ApplicationError.EXCEEDED,
  '404': ApplicationError.NOTFOUND,
  '500': ApplicationError.SERVER
};
